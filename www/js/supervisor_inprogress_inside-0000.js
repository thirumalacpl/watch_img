...
alert('if education');
 for(a=0;a<education_array.length;a++){
      ...
      education_array_obj = education_array[a];
       //alert(education_array_obj.city_name);
...
$('#from').html(' <p class="tabsss">From & To</p><p>'+currentobj_educational_records.from+'</p><p>'+currentobj_educational_records.to+'</p>');
   ...
   // alert('edu img');
     ...
     //$('.document_imag_inproo').append(' <div class="rondell-item rondell-item-focused  " style="opacity: 1; width: 149px; height: 200px; left: 125.5px; top: 10px; z-index: 1003; display: block;"><img src="http://115.118.113.83/watchguardlive/uploads/'+oneemp+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">  <div class="rondell-caption rondell-item-overlay" style="height: auto; overflow: auto; opacity: 1; display: block;"><p>My favourite band</p></div></div>');
